...
/**
 * Performance test for the Poc entity.
 */
class PocGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Poc entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created poc")
                .get("${new_poc_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created poc")
            .delete("${new_poc_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
